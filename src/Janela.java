...
public class Janela extends JFrame implements KeyListener, ActionListener{
	...
	public void PainelComunic(){
		listPanel.add(new JPanel(new MigLayout()));
				listPanel.get(2).setBorder(BorderFactory.createTitledBorder("ComunicaÃ§Ã£o Interna"));
	...
	public void ToolTipText(){
		...
		listButtons.get(3).setToolTipText("Abrir teste de conexÃ£o - Atalho F4");;
	...
	public void AcessoLinks(){
		JOptionPane.showMessageDialog(null, "<html>O browser aberto será o padrão da sua máquina pra alterar<br>"
										+ "vá em Painel Controle -> Propriedades de Internet -> Definir Programas -> Definir Programas padrão da internet</html>");
